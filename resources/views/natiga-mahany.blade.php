...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row mb-3">
            <label for="email" class="col-sm-2 col-form-label">الفرع</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" readonly value="{{ $result->section }}">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label for="email" class="col-sm-2 col-form-label">مجموع مواد الاختصاص</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" readonly value="{{ $result->total_subject_matter }}%">
            </div>
        </div>
        <div class="row mb-3">
            <label for="email" class="col-sm-2 col-form-label">مجموع مواد العامة</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" readonly value="{{ $result->total_subject_general }}%">
            </div>
        </div>
        <div class="row mb-3">
            <label for="email" class="col-sm-2 col-form-label">النتيجة العامة</label>
            <div class="col-sm-10">
